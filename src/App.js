    ...
    function () {
      async function fetchMovies() {
        try {
          ...
          if (!res.ok)
            throw new Error("Uh oh, something went wrong with fetching movies");
...
// // * Watched Box Component (right side)
// function WatchedBox() {
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>
                  {title} is on your list and you gave it<br></br>
                  {watchedUserRating} stars.<span>🌟</span>
                </p>
                // <span>🌟</span>
              )}
            </div>
